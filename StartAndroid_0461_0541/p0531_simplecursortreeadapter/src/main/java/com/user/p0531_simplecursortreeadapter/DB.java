package com.user.p0531_simplecursortreeadapter;
...
public class DB {
    ...
    public static final String COMPANY_TABLE_CREATE = "create table " +
            COMPANY_TABLE + "(" + COMPANY_COLUMN_ID + " integer primary key, " +
    ...
    public Cursor getPhoneData(long companyID){
        return mDB.query(PHONE_TABLE,null,PHONE_COLUMN_COMPANY + " = " + COMPANY_COLUMN_ID,null,null,null,null);
    }
    ...
    private class DBHelper extends SQLiteOpenHelper{
        ...
        public void onCreate(SQLiteDatabase db){
            ...
            String[] phonesSamsung = new String[] {"Galaxy s2","Galaxy s3","galaxy s4"};
